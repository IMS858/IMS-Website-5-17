...
(function () {
  ...
  var css = [
    ...
    'stroke-linecap:round;stroke-linejoin:round}',
    '.imsc-note{font-family:var(--util,system-ui),system-ui;font-size:.6875rem;',
    'color:#6b757e;margin:.5rem .1rem 0;line-height:1.4}',

    '.imsc-x{margin-left:auto;background:none;border:0;color:#aeb6be;cursor:pointer;',
    'width:32px;height:32px;display:flex;align-items:center;justify-content:center;border-radius:3px}',
